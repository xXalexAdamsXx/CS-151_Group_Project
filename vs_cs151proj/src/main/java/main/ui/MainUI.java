...
import main.services.InventoryService;
...
/**
 * The main user interface for the cashier system application.
 * Provides functionalities such as shift management, inventory management,
 * invoice management, tax and discount application, and receipt generation.
 */
public class MainUI extends JFrame {

    /**
     * Constructs the MainUI frame and initializes all panels.
     *
     * @param cashierName The name of the cashier currently logged in.
     */
    ...
    private JPanel createShiftPanel() {
        ...
        endShiftButton.addActionListener(e -> {
            ...
            JOptionPane.showMessageDialog(this, "Shift ended.");
        });
    ...
    private JPanel createInventoryPanel() {
        ...
        loadButton.addActionListener(e -> {
            try {
                InventoryService.loadInventory("StoreInfo.json");
    ...
    private JPanel createReceiptPanel() {
        ...
        printReceiptButton.addActionListener(e -> {
            receiptArea.setText(InvoiceService.generateReceipt());
        });
